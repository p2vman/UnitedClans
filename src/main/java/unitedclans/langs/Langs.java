...
public class Langs {
    public enum LangEN {
        ...
        YOU_ALREADY_LEADER("messages.you-already-leader", "§eYou are already the leader of this clan "),
        ...
        CONFIRM("menu-gui.confirm-role-menu.confirm", "Confirm "),
        CONFIRM_DESCRIPTION("menu-gui.confirm-role-menu.confirm-description", "Set the role Leader "),
        NOT_CONFIRM("menu-gui.confirm-role-menu.not-confirm", "Cancel "),
        NOT_CONFIRM_DESCRIPTION("menu-gui.confirm-role-menu.not-confirm-description", "Cancel the transfer of the role Leader "),
    ...
    public enum LangRU {
        ...
        CONFIRM("menu-gui.confirm-role-menu.confirm", "Подтвердить "),
        CONFIRM_DESCRIPTION("menu-gui.confirm-role-menu.confirm-description", "Установит роль Главы "),
        NOT_CONFIRM("menu-gui.confirm-role-menu.not-confirm", "Отмена "),
        NOT_CONFIRM_DESCRIPTION("menu-gui.confirm-role-menu.not-confirm-description", "Отменяет установку роли Главаы "),
