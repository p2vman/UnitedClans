...
public class Langs {
    ...
    public enum LangRU {
        ...
        SET_MEMBER_DESCRIPTION("menu-gui.change-role-menu.set-member-description", "Установит роль Участник "),
        SET_ELDER("menu-gui.change-role-menu.set-elder", "Старейшина "),
        SET_ELDER_DESCRIPTION("menu-gui.change-role-menu.set-elder-description", "Установит роль Старейшина "),
